class Word extends Object{
  ...
  Word.fromDatabase(this.recordnum, this.read, this._isMemorized, this.giw, this._mempool, this.smempool, this._mainText, this._audioFileName, this._firstValue, this._secondValue, this._displayFileName, this._displayAudioName);
